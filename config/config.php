...
$GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/ch_flowplayer/html/flowplayer/flowplayer-3.2.6.min.js';
...
(
	'ch_flowplayer' => array
		(
		'tables'       => array('tl_ch_flowplayer', 'tl_ch_flowplayer_playlist'),
...
$GLOBALS['TL_HOOKS']['getSearchablePages'][] = array('Module_chFlowPlayer', 'getSearchablePages');
